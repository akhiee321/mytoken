...
# Public variables
The code starts with assigning the name and abbreviation of the token using a string variable. The  name is token name is  'alien' and abbreviation as 'ali'
# Mapping variable
...
contract MyToken {
    ...
    string public tokenName = "alien";
    string public tokenAbbrv = "ali";
